...
import com.vitaltrip.vitaltrip.presentation.auth.docs.OAuthControllerDocs;
import com.vitaltrip.vitaltrip.presentation.health.dto.ApiResponse;
import com.vitaltrip.vitaltrip.presentation.auth.dto.OAuthDto;
import com.vitaltrip.vitaltrip.application.auth.OAuth2Service;
...
public class OAuth2Controller implements OAuthControllerDocs {
    ...
    public ApiResponse<OAuthDto.CompleteProfileResponse> completeProfile(
        ...
        OAuthDto.CompleteProfileResponse response = oauth2Service.completeProfile(tempToken, profileRequest);
